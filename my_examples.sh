...
# pf fetch structure=R1AB_SARS2 --af --type=cif --outdir data/mpro
# pf fetch structure=6LU7,6M2N,6ZRT,7BUY,7JQ2,7RVM,7RN1,7WOF,8FIW,8UPW --type=cif --outdir data/mpro
# pf protein-extract data/mpro/6LU7.cif --chains=A,B --remove-water --output data/mpro/6LU7_ab.cif
...
pf align-view --indir data/mpro P0DTD1_AF 6LU7_ab 6M2N_ae 6ZRT_ac 7BUY_a 7JQ2_ab 7RVM_ab 7RN1_ad 7WOF_ab 8FIW_ac 8UPW_ab
